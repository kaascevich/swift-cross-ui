...
open class Label: Misc {
    ...
    open override func didMoveToParent() {
        ...
        addSignal(name: "move-cursor", handler: gCallback(handler3)) { [weak self] (
            param0: GtkMovementStep,
            param1: Int,
            param2: Bool
        ) in
            guard let self else { return }
        ...
        addSignal(
            name: "notify::ellipsize",
            handler: gCallback(handler7)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyEllipsize?(self, param0)
        }

        let handler8: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::justify",
            handler: gCallback(handler8)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyJustify?(self, param0)
        }

        let handler9: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::label",
            handler: gCallback(handler9)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyLabel?(self, param0)
        }

        let handler10: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::lines",
            handler: gCallback(handler10)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyLines?(self, param0)
        }

        let handler11: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::max-width-chars",
            handler: gCallback(handler11)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyMaxWidthChars?(self, param0)
        }

        let handler12: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::mnemonic-keyval",
            handler: gCallback(handler12)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyMnemonicKeyval?(self, param0)
        }

        let handler13: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::pattern",
            handler: gCallback(handler13)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPattern?(self, param0)
        }

        let handler14: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::selectable",
            handler: gCallback(handler14)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySelectable?(self, param0)
        }

        let handler15: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::single-line-mode",
            handler: gCallback(handler16)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySingleLineMode?(self, param0)
        }

        let handler17: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::track-visited-links",
            handler: gCallback(handler17)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyTrackVisitedLinks?(self, param0)
        }

        let handler18: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::use-markup",
            handler: gCallback(handler18)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyUseMarkup?(self, param0)
        }

        let handler19: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::use-underline",
            handler: gCallback(handler19)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyUseUnderline?(self, param0)
        }

        let handler20: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::width-chars",
            handler: gCallback(handler20)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyWidthChars?(self, param0)
        }

        let handler21: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::wrap",
            handler: gCallback(handler21)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyWrap?(self, param0)
        }

        let handler22: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::wrap-mode",
            handler: gCallback(handler22)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyWrapMode?(self, param0)
        }

        let handler23: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
